...
function HowToSatSolvePage() {
  return (
    <div>
      ...
      <p>
        In Symmisolve, we use a specific format of Boolean SAT, that being CNF (Conjunctive
        Normal Form). Each formula consists of clauses, and each clause consists of
        variables.
      </p>
      <p>
        ...
        is the opposite of 1, and is also a literal. The opposite is denoted by a line over
        the variable.
      </p>
      <p>
      ...
      <p>
        ...
        is a valid CNF formula, because it is a joining by "AND" of clauses, and each clause
        is a joining by "OR" of variables.
      </p>
      <h2>Your Solving Tools</h2>
      <p>
        In Symmisolve, we use a specific format of Boolean SAT, that being CNF (Conjunctive
        Normal Form). Your goal is to determine if a formula is always false. For example,
        the formula{" "}
        <span className="code-segment">
          (1) &times; (<span className="overline">1</span>)
        </span>{" "}
        is always false, since the formula is false if 1 is false, and also false if 1 is
        true. If the formula is not always false, you can submit an assignment of variables
      ...
      <p>
        If you can find some assignment of variables that satisfies every clause involving
        an assigned variable, you can denote that as a possible assignment of those
        variables
      </p>
      <p>For example:</p>
      <p>
      ...
      <p>
        A valid partial solution would be <span className="code-segment">3</span>, since by
